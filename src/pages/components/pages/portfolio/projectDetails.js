        ...
        loader
            ...
            : <>
                <div className='py-10 md:py-20 flex flex-col items-center justify-center'>
                    ...
                    <div className='cooper text-[12px] md:text-[15px] tracking-[1px] text-[#917461] cursor-pointer' data-aos-duration="2500" data-aos="fade-down" onClick={() => navigate(`/category/${data?.categoryID?._id}`, { state: { name: data?.categoryID?.name } })}>
