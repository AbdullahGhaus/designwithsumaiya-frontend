            ...
            : <div className='flex flex-col gap-20 py-16 px-5 md:px-10 mb-5'>
                <div className='grid grid-cols-1 md:grid-cols-2 py-16'>
                    <div className='flex flex-col gap-14 justify-center'>
                        <div data-aos-duration="2000" data-aos="fade-right" data-aos-anchor-placement="top-bottom" className='flex flex-col gap-3'>
                            <span className='poppins text-[28px] md:text-[35px] text-[black] font-semibold'>Hey, this is {resume?.name}!</span>
                        ...
                        <a
                            href={resume?.url}
                            target={"_blank"}
                            className="poppins max-w-fit px-4 text-[10px] md:text-[12px] border-2 rounded-full border-[#fc88d2] py-2 text-white font-semibold bg-[#fc88d2]"
                            data-aos="zoom-in"
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-10'>
                    <div className='flex flex-col gap-3'>
                        <span className='poppins text-[black] font-semibold text-[25px] md:text-[30px]' data-aos="fade-right">Skilled In.</span>
                    ...
                    <div className='flex flex-col gap-3'>
                        <span className='poppins text-[black] font-semibold text-[25px] md:text-[30px]' data-aos="fade-right">Education.</span>
                ...
                <div className='flex flex-col gap-3'>
                    <span className='poppins text-[black] font-semibold text-[25px] md:text-[30px]' data-aos="fade-right">Experience.</span>
                    <div className='flex flex-col gap-5'>
